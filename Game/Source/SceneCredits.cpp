...
bool SceneCredits::Load()
{
	LOG("Loading Scene Ending");
	bool ret = true;
	bg = app->tex->Load("Assets/Textures/Credits.png");
...
{
	app->render->DrawTexture(bg, 0, 0, 0, 1.0F, 0.0, 2147483647, 2147483647, true, 1);
}

bool SceneCredits::UnLoad()
{
